...
function GetData() {
    cnacc_domain=(
        "https://raw.githubusercontent.com/hezhijie0327/GFWList2AGH/main/gfwlist2adguardhome_whitelist_full.txt"
    )
    gfwlist_domain=(
        "https://raw.githubusercontent.com/hezhijie0327/GFWList2AGH/main/gfwlist2adguardhome_blacklist_full.txt"
    )
